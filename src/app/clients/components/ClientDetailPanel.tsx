              ...
              {subscription && (
                <div className="border border-border rounded-xl p-4 space-y-3 bg-rose-50/40">
                  ...
                  <div className="border-t border-rose-100 pt-3 space-y-2">
                    <p className="text-[11px] font-600 text-rose-500 uppercase tracking-wide">Envoyer le lien de paiement</p>
                    <button
                    ...
                    >
                      {sendingPayment
                        ...
                        : <><Icon name="CreditCardIcon" size={14} />Par email{selectedPlan ? ` — ${selectedPlan.price} €` : ''}</>
                      }
                    </button>
                    {(() => {
                      ...
                      return (
                        <a
                          ...
                          className="w-full py-2.5 bg-[#25D366] text-white rounded-lg text-sm font-600 hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
                        >
